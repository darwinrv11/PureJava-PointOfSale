...
public class Login extends javax.swing.JFrame {
   login lg = new login();
    ...
    public Login() {
        ...
        initComponents();  
        txaparrafo.setEditable(false);
        txaparrafo.setFocusable(false);
   ...
   public void validar(){
    ...
    private void initComponents() {
        ...
        txaparrafo = new javax.swing.JTextArea();
        ...
        txtCorreo.setBackground(new java.awt.Color(255, 153, 102));
        ...
        txtPass.setBackground(new java.awt.Color(255, 153, 102));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 0, 330, 410));

        jPanel1.setBackground(new java.awt.Color(204, 255, 204));
        jPanel1.setForeground(new java.awt.Color(0, 255, 51));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/Logobotica.jpg"))); // NOI18N

        jLabel8.setFont(new java.awt.Font("Segoe UI", 3, 16)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 0, 51));
        jLabel8.setText("¡Bienvenido a BOTICA MILAGRITOS!");
        jLabel8.setToolTipText("jajsjja");

        txaparrafo.setBackground(new java.awt.Color(204, 255, 204));
        txaparrafo.setColumns(20);
        txaparrafo.setFont(new java.awt.Font("SimSun-ExtG", 0, 12)); // NOI18N
        txaparrafo.setLineWrap(true);
        txaparrafo.setRows(5);
        txaparrafo.setText("Ingresa con tus credenciales para acceder al\nsistema de ventas y gestionar el inventario.");
        jScrollPane2.setViewportView(txaparrafo);
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 0, 250, 430));
    ...
    private javax.swing.JTextArea txaparrafo;
